...
class Smarty_Internal_Config_File_Compiler
{
    ...
    /**
     * compiled configs data must always be written
     *
     * @var bool
     */
    ...
    /**
     * Method to compile Smarty configs source.
     *
    ...
    public function trigger_config_file_error($args = null)
    {
        ...
        // get configs source line which has error
        $line = $this->lex->line;
        if (isset($args)) {
            // $line--;
        }
        $match = preg_split("/\n/", $this->lex->data);
        $error_text = "Syntax error in configs file '{$this->template->source->filepath}' on line {$line} '{$match[$line - 1]}' ";
        if (isset($args)) {
